...
function switchCore(corename) {
   ...
   window.location.search = "?core=" + encodeURIComponent(corename);
}
...
$(function () {
   ...
   // Find which core to load from the URL or local storage.
   var urlCore = getParam("core");
   var core = urlCore || localStorage.getItem("core") || "gambatte";

   // Make the core the selected core in the UI.
   var coreTitle = $('#core-selector a[data-core="' + core + '"]')
      .addClass("active")
      .text();
